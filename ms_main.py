...
from ms_transform import TransformMaster
...
def main():
    ...
    report_year = int(today.strftime("%Y"))
    ...
    working_directory = f'{report_month}-{report_year}'
    ...
    for file in file_list:
        ...
        match file:
            ...
            case 'ecomm_fact.tsv':
                ...
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).ecom(partner_map,
                                                                                                          lcid_map,
                                                                                                          geo_map,
                                                                                                          price_map)
            case 'ms_surface_recommends_logo.tsv':
                ...
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).surface(
            ...
            case 'dccn_asset.tsv':
                ...
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).dccn_asset(
                    campaign_topic_map, asset_code)
            ...
            case 'dccn_partner.tsv':
                ...
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).dccn_partner(
                    geo_map)
            case 'dccn_gated.tsv':
            ...
            case 'ar_inline.tsv':
                ...
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).ar_master(geo_map,
                                                                                                                product_map)
            case 'ar_url.tsv':
            ...
            case 'ms_inline.tsv':
                ...
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).ms_inline(
                    partner_map, product_map, geo_map)
            case 'ms_w11.tsv':
                master = 'Master/ms_w11_raw.csv'
                bi_path = 'PowerBI/PBI-MSInline/ms_w11_raw_pb.csv'
            ...
            case 'ms_sis.tsv':
                master = 'Master/ms_sis_raw.csv'
                bi_path = 'PowerBI/PBI-MSInline/ms_sis_raw_pb.csv'
                TransformMaster(download, stage, master, bi_path, alphanum_month, working_directory).ms_sis()
            ######################HP LENOVO DELL XIS#############################
            ...
            case 'ms_xis.tsv':
                ...
                bi_path = 'PowerBI/PBI-MSInline/xis_injection_raw.csv'
            ...
            #     bi_path = 'PowerBI/PBI-Other/asus_qbr_raw.csv'
